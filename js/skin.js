...
$(document).ready(function() {
	...
	if ( - 1 != d && -1 != e && e > d) {
		...
		32 == f.length && ($("#container a").each(function() {
			var a = $(this).attr("href"); a&&a!=null&&-1 != a.indexOf("../")&&$(this).attr("href", "../" + a)
...
$(function() {
	$(window).bind("scroll",
	function() {
		$("#my_left_bar").css("top", $(window).scrollTop() + 155)
	}),
	$("#my_left_bar").length > 0 && $("#my_left_bar").append('<img style=" position:absolute; right:9px; z-index:999999; top:5px;" id="close_leftnav" src="/cnpc/xhtml/images/public/close_aa.gif" />'),
	$(".skin").length > 0 && $(".skin").append('<img style=" position:absolute; right:3px; z-index:999999; top:3px;" id="close_rightnav" src="/cnpc/xhtml/images/public/close_aa.gif" />'),
